...
and create financial indices using the indexmaker API.
"""
...
# System prompt that teaches the LLM about indexmaker's API
...
def create_index_from_description(
    ...
    **kwargs,
    ...
    Example:
        >>> from indexmaker.ai import create_index_from_description
        >>>
