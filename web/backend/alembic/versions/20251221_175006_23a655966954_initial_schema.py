...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_corporate_actions_effective_date"),
        "corporate_actions",
        ["effective_date"],
        unique=False,
    )
    op.create_index(
        op.f("ix_corporate_actions_ticker"), "corporate_actions", ["ticker"], unique=False
    )
    op.create_table(
        "delivery_logs",
        sa.Column("id", sa.UUID(as_uuid=False), nullable=False),
    ...
    op.create_index(
        op.f("ix_custom_data_sources_owner_id"), "custom_data_sources", ["owner_id"], unique=False
    )
    op.create_table(
        "email_subscriptions",
        sa.Column("id", sa.UUID(as_uuid=False), nullable=False),
    ...
    op.create_index(
        op.f("ix_custom_securities_data_source_id"),
        "custom_securities",
        ["data_source_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_custom_securities_ticker"), "custom_securities", ["ticker"], unique=False
    )
    op.create_table(
        "indices",
        sa.Column("id", sa.UUID(as_uuid=False), nullable=False),
    ...
    op.create_index(
        op.f("ix_embed_widgets_embed_token"), "embed_widgets", ["embed_token"], unique=True
    )
    op.create_table(
        "generated_reports",
        sa.Column("id", sa.UUID(as_uuid=False), nullable=False),
    ...
    op.create_index(
        op.f("ix_generated_reports_public_token"),
        "generated_reports",
        ["public_token"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_index_components_index_id"), "index_components", ["index_id"], unique=False
    )
    op.create_index(
        op.f("ix_index_components_ticker"), "index_components", ["ticker"], unique=False
    )
    op.create_table(
        "index_corporate_action_logs",
        sa.Column("id", sa.UUID(as_uuid=False), nullable=False),
        sa.Column("index_id", sa.UUID(as_uuid=False), nullable=False),
    ...
    op.create_index(
        op.f("ix_index_snapshots_index_id"), "index_snapshots", ["index_id"], unique=False
    )
    op.create_table(
        "public_shares",
        sa.Column("id", sa.UUID(as_uuid=False), nullable=False),
