...
class SFTPDestination(Base):
    ...
    # Schedule
    frequency: Mapped[str] = mapped_column(String(20), default=DeliveryFrequency.DAILY.value)
...
class EmailSubscription(Base):
    ...
    # Schedule
    frequency: Mapped[str] = mapped_column(String(20), default=DeliveryFrequency.WEEKLY.value)
    ...
    report_type: Mapped[str] = mapped_column(
        String(50), default="factsheet"
    )  # factsheet, performance, full
