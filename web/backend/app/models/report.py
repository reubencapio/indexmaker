...
class ReportTemplate(Base):
    ...
    report_type: Mapped[str] = mapped_column(String(20), default=ReportType.FACTSHEET.value)
...
class GeneratedReport(Base):
    ...
    report_format: Mapped[str] = mapped_column(String(10), default=ReportFormat.PDF.value)
